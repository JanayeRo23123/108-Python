...
def computer_store():
    catalog = [
        ...
        {"title": "KUltrawide Monitor", "price": 425.16},
        {"title": "Webcam", "price": 42.50},
    ]

    #a) print the titles 
    #b) the total value of the catalog (sums all prices)
    total = 0
    for prod in catalog:
        print(prod["title"])
        total += prod["price"]
...
def school():
    ...
    # a) print First Last for A students 
    # b) the total balance of all students
    total = 0
